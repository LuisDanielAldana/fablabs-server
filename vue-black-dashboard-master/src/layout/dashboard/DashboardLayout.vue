  ...
  <div class="wrapper">
    <side-bar>
      <template slot="links">
        ...
        <sidebar-link to="/usuarios" :name="$t('usuarios')" icon="tim-icons icon-align-center"/>
        <sidebar-link to="/servicios" :name="$t('servicios')" icon="tim-icons icon-align-center"/>
        <sidebar-link to="/equipo" :name="$t('equipo')" icon="tim-icons icon-align-center"/>
      </template>
    </side-bar>
